    ...
    return [
        {
            "name": "water_asset_a",
            "location": "oxford",
            "capital_cost": {"units": "£", "value": 1000},
            "economic_lifetime": {"units": "years", "value": 25},
            "operational_lifetime": {"units": "years", "value": 25},
        },
        {
            "name": "water_asset_b",
            "location": "oxford",
            "capital_cost": {"units": "£", "value": 1500},
            "economic_lifetime": {"units": "years", "value": 25},
            "operational_lifetime": {"units": "years", "value": 25},
        },
        {
...
def model_run():
    ...
    return {
        ...
        "timesteps": [2015, 2020, 2025],
        "sos_model": "energy",
        "scenarios": {"population": "High Population (ONS)"},
        "strategies": [
            {
        ...
        "narratives": {
            "technology": ["Energy Demand - High Tech"],
...
def get_sos_model(sample_narratives):
    ...
    return {
        ...
        "sector_models": ["energy_demand", "energy_supply"],
    ...
    for scenario in [scenario_with_timestep]:
        for variant in scenario["variants"]:
            for data_key, data_value in variant["data"].items():
                spec_dict = [
                    provides
                    for provides in scenario["provides"]
        ...
        "variants": [
            {
                ...
                "data": {"smart_meter_savings": "high_tech_dsm.csv"},
            }
        ],
    }
...
def sample_narratives(get_narrative):
    ...
    return [
        get_narrative,
        {
            ...
            "provides": {"energy_demand": ["homogeneity_coefficient"]},
            "variants": [
                {
                    ...
                    "data": {"homogeneity_coefficient": "homogeneity_coefficient.csv"},
                },
            ],
        },
    ]
...
def sample_dimensions(remap_months, hourly, annual, lad):
    ...
    return [
        ...
        {"name": "county", "elements": [{"name": "oxford"}]},
        {
            "name": "season",
            "elements": [
                {"name": "cold_month"},
...
def get_dimension():
    return {
        ...
        "elements": [{"id": 1, "interval": [["PT0H", "PT8760H"]]}],
    }
...
def hourly():
    return [
        {"name": n, "interval": [["PT{}H".format(n), "PT{}H".format(n + 1)]]}
...
@fixture
def annual():
    return [{"name": 1, "interval": [["PT0H", "PT8760H"]]}]
...
def remap_months():
    ...
    data = [
        {
            "name": "cold_month",
            "interval": [["P0M", "P1M"], ["P1M", "P2M"], ["P11M", "P12M"]],
        },
        {
            "name": "spring_month",
            "interval": [["P2M", "P3M"], ["P3M", "P4M"], ["P4M", "P5M"]],
        },
        {
            "name": "hot_month",
            "interval": [["P5M", "P6M"], ["P6M", "P7M"], ["P7M", "P8M"]],
        },
        {
            "name": "fall_month",
            "interval": [["P8M", "P9M"], ["P9M", "P10M"], ["P10M", "P11M"]],
        },
    ]
    return data
...
@fixture
def state():
    return [{"name": "test_intervention", "build_year": 1900}]
