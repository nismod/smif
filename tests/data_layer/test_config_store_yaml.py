...
class TestSectorModel:
    ...
    def test_sector_model_read_all(self, get_sector_model, config_handler):
        ...
        sector_model_names = list(
            sector_model["name"] for sector_model in sector_models
        )
...
class TestScenarios:
    ...
    def test_read_scenario_definition(
        self, setup_folder_structure, config_handler, sample_scenarios
    ):
