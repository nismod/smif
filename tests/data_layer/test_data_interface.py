...
def test_datafileinterface_region_definition_data(setup_folder_structure, get_project_config,
    ...
    config_handler = DatafileInterface(str(basefolder))
    test_region_definition = config_handler.read_region_definition_data('lad')
...
def test_datafileinterface_project_region_definitions(setup_folder_structure,
                                                      get_project_config):
...
def test_datafileinterface_project_interval_definitions(setup_folder_structure,
                                                        get_project_config):
    """ Test to read and write the project configuration
    """
    basefolder = setup_folder_structure
    ...
    config_handler.update_interval_definition(interval_definition['name'], interval_definition)
    interval_definitions = config_handler.read_interval_definitions()
    assert len(interval_definitions) == 3
    for interval_definition in interval_definitions:
        if interval_definition['name'] == 'monthly':
    ...
    config_handler.update_interval_definition('monthly', interval_definition)
    interval_definitions = config_handler.read_interval_definitions()
    assert len(interval_definitions) == 3
    for interval_definition in interval_definitions:
...
def test_datafileinterface_project_scenario_sets(setup_folder_structure, get_project_config):
    """ Test to read and write the project configuration
    """
    basefolder = setup_folder_structure
    project_config_path = os.path.join(str(basefolder), 'config', 'project.yml')
...
def test_datafileinterface_project_narrative_sets(setup_folder_structure, get_project_config):
    """ Test to read and write the project configuration
    """
    basefolder = setup_folder_structure
    project_config_path = os.path.join(str(basefolder), 'config', 'project.yml')
