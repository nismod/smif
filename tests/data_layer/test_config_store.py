...
class TestModelRuns:
    ...
    def test_write_model_run(self, handler, minimal_model_run):
        new_model_run = {"name": "new_model_run_name", "description": "Model run 2"}
    ...
    def test_update_model_run(self, handler):
        updated_model_run = {"name": "test_modelrun", "description": "Model run"}
...
class TestStrategies:
    ...
    def test_read_strategies(self, handler, strategies):
        ...
        assert sorted(actual, key=lambda d: d["description"]) == sorted(
            expected, key=lambda d: d["description"]
        )
...
class TestScenarios:
    ...
    def test_update_scenario_variant(self, handler):
        new_variant = {
            ...
            "data": {"mortality": "mortality_low.csv"},
        }
